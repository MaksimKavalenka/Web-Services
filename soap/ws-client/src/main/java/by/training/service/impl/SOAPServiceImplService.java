 ...
 * 
 */
@WebServiceClient(name = "SOAPServiceImplService", targetNamespace = "http://impl.service.training.by/", wsdlLocation = "http://localhost:8080/ws-service/soap?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ws-service/soap?wsdl");
